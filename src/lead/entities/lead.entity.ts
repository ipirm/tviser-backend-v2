...
export class LeadEntity extends BaseEntity {
  ...
  @ApiProperty({ example: "Саша", description: "Имя", required: false })
  @IsString()
  @Column()
  @IsOptional()
  name: string;
  ...
  @ApiProperty({ example: "+7 555 55 55", description: "Номер", required: true })
  @IsString()
  @Column()
  @IsOptional()
  phone: string;

  @ApiProperty({ example: "Сообщение", description: "Сообщение", required: false })
  @IsString()
  @Column()
  @IsOptional()
  text: string;
